...
import { useState, useEffect } from 'react'
import { Brain, Plus, Download, Trash2, Settings } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Models</h1>
          <p className="text-gray-600 mt-2">Manage your custom AI models</p>
        </div>
        ...
        {models.map((model) => (
          <div key={model.id} className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            ...
            <div className="space-y-2 mb-4">
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">Size:</span>
                <span className="text-gray-900">{model.size}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">Created:</span>
                <span className="text-gray-900">{model.created_at}</span>
              </div>
            </div>

            <div className="flex justify-between">
              <button className="flex items-center space-x-1 px-3 py-1 text-sm text-indigo-600 hover:bg-indigo-50 rounded transition-colors">
                <Settings className="h-4 w-4" />
                <span>Configure</span>
              </button>
              <div className="flex space-x-2">
                ...
                <button className="flex items-center space-x-1 px-3 py-1 text-sm text-red-600 hover:bg-red-50 rounded transition-colors">
                  <Trash2 className="h-4 w-4" />
                </button>
              </div>
            </div>
      ...
      {models.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 mb-4">Get started by adding your first custom model.</p>
